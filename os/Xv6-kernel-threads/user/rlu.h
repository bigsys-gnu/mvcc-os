...
#define RLU_MAX_WRITER_LOCKS (100)
...
#define RLU_MOVE_PTR_BACK(p_obj, offset) ((void *)(((volatile unsigned char *)p_obj) - offset))
...
typedef struct rlu_obj_header {
	volatile void *p_obj_copy;
} rlu_obj_header_t;

typedef struct rlu_ws_obj_header {
	volatile void *p_obj_actual;
...
typedef struct rlu_thread_data {
	...
	void *free_nodes[RLU_MAX_FREE_NODES];
...
#define RLU_FREE(self, p_obj) rlu_free(self, (void *)p_obj)

#define RLU_TRY_WRITER_LOCK(self, writer_lock_id) rlu_try_writer_lock(self, writer_lock_id)
#define RLU_LOCK(self, p_p_obj) rlu_lock(self, (void **)p_p_obj, sizeof(**p_p_obj))

#define RLU_TRY_LOCK(self, p_p_obj) rlu_try_lock(self, (void **)p_p_obj, sizeof(**p_p_obj))
#define RLU_TRY_LOCK_CONST(self, obj) RLU_TRY_LOCK(self, &(obj))
#define RLU_ABORT(self) rlu_abort(self)

#define RLU_IS_SAME_PTRS(p_obj_1, p_obj_2) rlu_cmp_ptrs((void *)p_obj_1, (void *)p_obj_2)
#define RLU_ASSIGN_PTR(self, p_ptr, p_obj) rlu_assign_pointer((void **)p_ptr, (void *)p_obj)

#define RLU_DEREF(self, p_obj) RLU_DEREF_INTERNAL(self, (void *)p_obj)
